export const TABLE_GRAIN_MISSION = Object.freeze({
  ...
  cases: Object.freeze([
    Object.freeze({
      ...
      grain:'one completed sale', grainOptions:['one completed sale','one product sold','one branch per day'],
    ...
    Object.freeze({
      ...
      grain:'one product line within one sale', grainOptions:['one product line within one sale','one completed sale','one individual physical item'],
      count:'number of sale lines', countOptions:['number of sale lines','number of completed sales','sum of item quantities'],
    ...
    Object.freeze({
      ...
      grain:'one product SKU', grainOptions:['one product SKU','one product sale','one category'],
    ...
    Object.freeze({
      ...
      count:'number of branch-days', countOptions:['number of branch-days','number of branches','number of sales'],
    ...
    Object.freeze({
      ...
      grain:'one product at one branch at one observation time', grainOptions:['one product at one branch at one observation time','one product at one branch','one stock movement'],
      count:'number of inventory snapshots', countOptions:['number of inventory snapshots','number of products','total units on hand'],
    ...
    Object.freeze({
      ...
      count:'number of scheduled shifts', countOptions:['number of scheduled shifts','number of employees','total hours worked'],
