...
export const PHASE_ONE = Object.freeze([
  ...
  Object.freeze({ id: '4.1', module: 4, title: 'Read a query like a sentence',
    ...
    note: 'Sourced 2026-09-04 from the new chapter 05.01, which teaches exactly this claim. The slot had carried no source since Phase One was written.' }),
  ...
  Object.freeze({ id: '4.6', module: 4, title: 'Three checks before you believe it',
    ...
    from: Object.freeze({ chapter: 5, session: 5 }) }),
