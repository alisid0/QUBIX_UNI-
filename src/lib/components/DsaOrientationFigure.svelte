...
<style>
  ...
  .loose-cards i { position:absolute; display:grid; place-items:center; width:61px; height:33px; border:2px solid #000; background:var(--qx-slip); color:var(--qx-slip-ink); font:900 10px var(--qx-font); font-style:normal; box-shadow:3px 3px 0 #000; }
  ...
  .connector span { display:block; font-size:9px; font-weight:900; letter-spacing:.08em; }
  ...
  .shape-grid article > small { margin-top:2px; color:var(--qx-ink-text-2); font-size:10px; }
  .row-visual,.line-visual { display:flex; align-items:center; height:42px; gap:3px; }
  .row-visual i { display:grid; place-items:center; width:27px; height:27px; border:1px solid var(--qx-ink-text-2); color:var(--qx-ink-text); font:900 9px var(--qx-font); font-style:normal; }
  ...
  .line-visual em { margin-left:4px; color:var(--qx-ink-accent); font:900 9px var(--qx-font); font-style:normal; }
  ...
  .operation-rail b { flex:1; padding:7px 5px; border:1px solid var(--qx-ink-accent); color:var(--qx-ink-accent); text-align:center; font-size:10px; }
