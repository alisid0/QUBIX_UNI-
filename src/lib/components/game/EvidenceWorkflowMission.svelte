...
<style>
  ...
  .eyebrow{margin:0 0 6px;color:#b85530;font:900 9px var(--qx-font);letter-spacing:.14em}.file-head h2,.question h2,.completion h2{margin:0;font:400 27px/1.08 Georgia,serif;text-wrap:balance}
  .file-head>span{display:grid;place-items:center;min-width:50px;height:34px;background:#20241f;color:#fff;font:900 10px var(--qx-font)}
  .brief{margin:0;padding:20px 24px;color:#51584f;font:650 14px/1.6 var(--qx-font)}
  .evidence-table{margin:0 24px;border:2px solid #20241f}.evidence-table>div{display:grid;grid-template-columns:minmax(125px,34%) 1fr;border-bottom:1px solid #9c998d}.evidence-table>div:last-child{border-bottom:0}.evidence-table b,.evidence-table span{padding:12px 13px}.evidence-table b{background:#e1dacd;font:900 10px/1.4 var(--qx-font);letter-spacing:.04em}.evidence-table span{font:700 12.5px/1.45 ui-monospace,"SF Mono",Consolas,monospace;overflow-wrap:anywhere}
  .case-rule{margin:22px 24px 26px;padding:14px 16px;display:grid;gap:5px;border-left:5px solid #315f48;background:#e3e9df}.case-rule b{color:#315f48;font:900 9px var(--qx-font);letter-spacing:.12em}.case-rule span{font:650 12.5px/1.5 var(--qx-font)}
  .decision-card nav{display:flex;gap:1px;margin-bottom:22px;background:#c8c1b1}.decision-card nav span{flex:1;min-width:0;padding:8px 7px;display:flex;align-items:center;gap:6px;background:#e7e1d5;color:#6f756b;font:850 9px var(--qx-font);letter-spacing:.04em}.decision-card nav span b{display:grid;place-items:center;width:20px;height:20px;background:#c8c1b1;color:#20241f}.decision-card nav span.past{background:#dce5d7;color:#315f48}.decision-card nav span.on{background:#20241f;color:#fff}.decision-card nav span.on b{background:#b85530;color:#fff}
  ...
  footer{display:flex;justify-content:space-between;gap:16px;flex-wrap:wrap;font:650 10.5px/1.5 var(--qx-font)}.source-links{display:flex;align-items:center;gap:5px;flex-wrap:wrap}.source-links a{display:inline-flex;align-items:center;gap:5px}.source-links small{padding:2px 4px;border:1px solid currentColor;font:850 7.5px var(--qx-font);text-decoration:none}
