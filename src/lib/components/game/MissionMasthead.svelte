...
<style>
  ...
  .copy{min-width:0}
  .copy p{margin:0 0 8px;color:#b85530;font:900 10px var(--qx-font);letter-spacing:.14em;text-transform:uppercase}
  ...
  .copy>span{display:block;margin-top:12px;color:#62695f;font:800 10.5px var(--qx-font);letter-spacing:.08em;text-transform:uppercase}
  ...
  .room small{color:#b85530;font:900 8.5px var(--qx-font);letter-spacing:.13em}
  .room b{margin-top:3px;font:400 17px Georgia,serif}
  .room em{margin-top:8px;color:#315f48;font:800 9px var(--qx-font);font-style:normal;letter-spacing:.04em}
