...
<style>
  .computer{width:100%;color:#241f16;font-family:var(--qx-font)}.bezel{padding:14px;border-radius:18px;background:#241f16;box-shadow:0 20px 35px rgba(0,0,0,.28)}.screen{position:relative;aspect-ratio:16/10;min-height:430px;overflow:hidden;border-radius:8px;background:#d8d0be}.system-bar,.taskbar{height:34px;display:flex;align-items:center;justify-content:space-between;padding:0 11px;background:#241f16;color:#f1ede4;font-size:12px;letter-spacing:.08em}.brand,.system-status{display:flex;align-items:center;gap:7px}.cube{display:grid;place-items:center;width:19px;height:19px;border-radius:4px;background:#a85a34;color:#f1ede4;font-weight:900}.online{width:7px;height:7px;border-radius:50%;background:#3e9e2a}.desktop{position:absolute;inset:34px 0;background:linear-gradient(135deg,#f1ede4 0 52%,#e7efdc 52%)}.wallpaper{position:absolute;right:7%;bottom:13%;display:grid;text-align:right}.wallpaper span{color:#8c4c2e;font-size:12px;font-weight:900;letter-spacing:.15em}.wallpaper strong{font:700 clamp(20px,3vw,35px) Georgia,serif}.wallpaper small{margin-top:4px;color:#726a58;font-size:12px}.desktop-icons{position:relative;z-index:1;display:grid;grid-template-columns:repeat(2,92px);gap:12px;padding:22px}.desktop-icons button{display:grid;justify-items:center;gap:5px;min-height:90px;padding:8px;border:1px solid transparent;border-radius:10px;background:transparent;color:#241f16;cursor:pointer}.desktop-icons button:hover,.desktop-icons button:focus-visible{border-color:#a85a34;background:rgba(255,255,255,.55);outline:none}.desktop-icons button span{width:42px;height:42px}.desktop-icons b{font-size:12px}.window{position:absolute;inset:49px 14px 49px;border:1px solid #8f8776;border-radius:10px;overflow:hidden;background:#f1ede4;box-shadow:0 14px 28px rgba(36,31,22,.22)}.window-title{height:36px;display:flex;align-items:center;justify-content:space-between;padding:0 8px;background:#ece7dc;border-bottom:1px solid #d8d0be}.window-title>div{display:flex;align-items:center;gap:7px;font-size:13px}.window-mark{width:22px;height:22px}.window-title>button{width:28px;height:28px;border:0;border-radius:6px;background:transparent;color:#241f16;font-size:20px;cursor:pointer}.window-title>button:hover{background:#f7dcd6;color:#a02d1d}.app-content{height:calc(100% - 36px);box-sizing:border-box;padding:18px;overflow:auto}.app-kicker{margin:0 0 4px;color:#8c4c2e;font-size:11.5px;font-weight:900;letter-spacing:.14em}.app-content h3{margin:0 0 15px;font:700 22px Georgia,serif}.mission-list{display:grid;gap:8px}.mission-list article{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:10px 12px;border-left:4px solid #3e9e2a;background:#fff}.mission-list article.locked{border-left-color:#9e947e;background:#ece7dc}.mission-list article div{display:grid;gap:2px}.mission-list small{color:#8c4c2e;font-size:11px;font-weight:900;letter-spacing:.12em}.mission-list b{font-size:13.5px}.mission-list span{color:#726a58;font-size:11.5px}.mission-list em{padding:5px 7px;border-radius:999px;background:#e7efdc;color:#3c6427;font-size:11px;font-style:normal;font-weight:900}.mission-list .locked em{background:#d8d0be;color:#57503f}.app-heading{display:flex;align-items:flex-start;justify-content:space-between;gap:12px}.run{min-height:35px;padding:0 12px;border:0;border-radius:8px;background:#a85a34;color:#fff;font-size:12px;font-weight:900;cursor:pointer}.table-wrap{overflow-x:auto;border:1px solid #d8d0be}.feed-app table{width:100%;border-collapse:collapse;white-space:nowrap;background:#fff}.feed-app th,.feed-app td{padding:8px;border-bottom:1px solid #e4ddce;text-align:left;font-size:11.5px}.feed-app th{background:#ece7dc;color:#57503f}.feed-app tr{cursor:pointer}.feed-app tr.selected{background:#f2e4da}.feed-app tr.issue{background:#f7dcd6;color:#a02d1d;font-weight:900}.detail{display:flex;align-items:center;gap:10px;margin-top:12px;padding:10px;background:#ece7dc}.detail.warning{background:#f7dcd6}.asset-icon{display:block;flex:0 0 38px;width:38px;height:38px}.detail p{display:grid;gap:3px;margin:0}.detail b{font-size:13px}.detail span:not(.asset-icon){color:#57503f;font-size:11.5px;line-height:1.45}.dictionary-app dl{margin:0}.dictionary-app dl div{display:grid;grid-template-columns:150px 1fr;gap:12px;padding:11px 0;border-bottom:1px solid #d8d0be}.dictionary-app dt{font-size:12px;font-weight:900}.dictionary-app dd{margin:0;color:#57503f;font-size:12px}.checks-app ul{display:grid;gap:8px;margin:0;padding:0;list-style:none}.checks-app li{display:flex;align-items:center;gap:12px;padding:11px;background:#fff}.checks-app li.locked{opacity:.62;background:#ece7dc}.checks-app li>span:not(.asset-icon){display:grid;gap:3px}.checks-app li b{font-size:13px}.checks-app li small{color:#726a58;font-size:11.5px}.taskbar{position:absolute;right:0;bottom:0;left:0}.taskbar button{padding:0;border:0;background:transparent;cursor:pointer}.taskbar>span{margin-right:auto;margin-left:8px;color:#cfc6b4}.taskbar time{font-variant-numeric:tabular-nums}.stand{display:grid;justify-items:center}.stand:before{content:'';width:62px;height:44px;background:#241f16}.stand span{width:150px;height:12px;border-radius:8px 8px 2px 2px;background:#241f16}@media(max-width:620px){.bezel{padding:8px;border-radius:13px}.screen{min-height:500px;aspect-ratio:auto}.desktop-icons{grid-template-columns:repeat(2,minmax(78px,1fr));padding:18px}.wallpaper{right:5%;bottom:8%}.window{inset:44px 7px 43px}.app-content{padding:12px}.app-heading{align-items:stretch;flex-direction:column}.run{width:100%}.dictionary-app dl div{grid-template-columns:1fr;gap:4px}.system-status{display:none}.mission-list article{align-items:flex-start}.mission-list em{white-space:nowrap}.stand{display:none}}@media(prefers-reduced-motion:reduce){*{scroll-behavior:auto}}
  .mission-list article.prototype{border-left-color:#a85a34;background:#f2e4da}.mission-list a{padding:5px 7px;border-radius:999px;background:#a85a34;color:#fff;font-size:11px;font-weight:900;white-space:nowrap;text-decoration:none}.mission-list a:focus-visible{outline:2px solid #241f16;outline-offset:2px}
</style>
