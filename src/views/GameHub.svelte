...
<style>
  ...
  .room-top{display:flex;justify-content:space-between;gap:12px;text-transform:uppercase}.room-top b{font:800 12px var(--qx-font);letter-spacing:.13em}.room-top em{color:var(--accent);font:800 11.5px var(--qx-font);font-style:normal}.image-slot{margin:auto;color:#857f72;font:800 11px var(--qx-font);letter-spacing:.13em}.room small{color:var(--soft);font:600 11.5px/1.35 var(--qx-font)}.room-state{margin-top:8px;color:var(--signal);font:900 11px var(--qx-font);letter-spacing:.09em;text-transform:uppercase}.you-are-here{position:absolute;left:18%;top:56%;padding:10px 13px;background:var(--signal);color:#fff;font:900 11px var(--qx-font);letter-spacing:.08em}.image-note{margin:18px 0 0;color:var(--soft);font:500 12px/1.5 var(--qx-font)}
