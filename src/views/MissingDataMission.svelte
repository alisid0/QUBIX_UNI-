...
<style>
  ...
  main{display:block}
  .stage-card{max-width:1320px;margin:0 auto}.stage-card.open{background:#17201f}.stage-card.open .stage-heading{border-bottom:1px solid #344c43;background:#17201f}.stage-card.open .stage-heading h2{color:#eef3ec}
