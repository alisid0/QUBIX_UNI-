...
<style>
  ...
  header{position:sticky;top:0;z-index:20;display:flex;align-items:center;justify-content:space-between;gap:18px;min-height:70px;padding:9px clamp(14px,4vw,48px);border-bottom:1px solid var(--qx-border);background:color-mix(in srgb,var(--qx-bg) 92%,transparent);backdrop-filter:blur(14px)}.identity,.header-actions{display:flex;align-items:center;gap:11px}.identity>span:last-child{display:grid;gap:3px}.identity b{font-size:13.5px;letter-spacing:.14em}.identity small{color:var(--qx-text-faint);font-size:12px}.mark{display:grid;place-items:center;width:38px;height:38px;border:1px solid var(--qx-accent);border-radius:50%;color:var(--qx-accent-text);font-family:serif;font-size:18px}.pill{border:1px solid var(--qx-border-2);border-radius:999px;padding:6px 10px;color:var(--qx-text-faint);font-size:11.5px;font-weight:900;letter-spacing:.08em}.theme{width:38px;height:38px;border:1px solid var(--qx-border);border-radius:50%;background:var(--qx-surface);color:var(--qx-text);cursor:pointer}
  main{width:min(1220px,calc(100% - 28px));margin:0 auto;padding:34px 0 68px}.hero{display:grid;grid-template-columns:1fr 260px;gap:32px;align-items:end}.micro{color:var(--qx-accent-text);font-size:12px;font-weight:900;letter-spacing:.09em}.hero h1{margin:8px 0 10px;font-size:clamp(32px,5vw,56px);line-height:1.02}.hero p{max-width:76ch;margin:0;color:var(--qx-text-2);font-size:14px;line-height:1.62}.progress-card{display:grid;gap:7px;border:1px solid var(--qx-border);border-radius:14px;background:var(--qx-surface);padding:15px}.progress-card>span{color:var(--qx-text-faint);font-size:11.5px;font-weight:900}.progress-card>b{font-size:29px}.progress-card b i{color:var(--qx-text-faint);font-size:14px;font-style:normal}.progress-card>div{height:6px;overflow:hidden;border-radius:999px;background:var(--qx-surface-3)}.progress-card>div i{display:block;height:100%;background:var(--qx-green)}.progress-card small{color:var(--qx-text-2);font-size:12px}
  .tabs{display:flex;gap:6px;margin:28px 0 22px;padding-bottom:8px;overflow-x:auto}.tabs button{flex:0 0 auto;min-height:42px;border:1px solid var(--qx-border);border-radius:10px;background:var(--qx-surface);color:var(--qx-text-2);padding:8px 12px;font-size:12px;font-weight:900;cursor:pointer}.tabs button.on{border-color:var(--qx-accent);background:var(--qx-accent-soft);color:var(--qx-accent-text)}
  .metric-grid{display:grid;grid-template-columns:repeat(6,1fr);gap:9px}.metric-grid article{display:grid;gap:5px;border:1px solid var(--qx-border);border-radius:13px;background:var(--qx-surface);padding:13px}.metric-grid span{color:var(--qx-text-faint);font-size:11.5px;font-weight:900}.metric-grid b{font-size:24px}.metric-grid p{margin:0;color:var(--qx-text-2);font-size:12px;line-height:1.3}.overview-grid{display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-top:12px}.card{border:1px solid var(--qx-border);border-radius:15px;background:var(--qx-surface);padding:17px}.card h2{margin:0 0 12px;font-size:16px}.card p,.card li{color:var(--qx-text-2);font-size:13.5px;line-height:1.55}.card ol{display:grid;gap:7px;margin:0;padding-left:20px}.alignment-list{display:grid;gap:8px}.alignment-list span{display:grid;grid-template-columns:62px 1fr;gap:9px;color:var(--qx-text-2);font-size:13.5px;line-height:1.45}.alignment-list b{color:var(--qx-accent-text);font-size:12px}.decision-summary{display:grid;grid-template-columns:1fr 1fr;gap:7px}.decision-summary h2{grid-column:1/-1}.decision-summary button{display:flex;align-items:center;gap:8px;border:1px solid var(--qx-border);border-radius:9px;background:var(--qx-surface-2);color:var(--qx-text);padding:8px;cursor:pointer}.decision-summary button b{font-size:13px}.decision-summary button em{margin-left:auto;color:var(--qx-text-faint);font-size:13.5px;font-style:normal}.dot{width:9px;height:9px;flex:0 0 auto;border-radius:50%;background:var(--qx-text-faint)}.dot.migrate{background:var(--qx-green)}.dot.adapt{background:var(--qx-accent)}.dot.defer{background:var(--qx-yellow)}.dot.reject{background:var(--qx-danger)}.dot.infrastructure{background:var(--qx-text-dim)}
  .filters{display:grid;grid-template-columns:1fr 180px 190px auto;gap:9px;align-items:end;margin-bottom:10px}.filters label,.notes{display:grid;gap:5px;color:var(--qx-text-faint);font-size:11.5px;font-weight:900}.filters input,.filters select,.notes textarea{width:100%;box-sizing:border-box;border:1px solid var(--qx-border);border-radius:9px;background:var(--qx-surface);color:var(--qx-text);padding:9px 10px;font:inherit}.filters>span{padding:10px;color:var(--qx-text-faint);font-size:12px}.inventory-layout{display:grid;grid-template-columns:minmax(300px,.82fr) minmax(440px,1.18fr);gap:12px;align-items:start}.inventory-list{max-height:670px;overflow:auto;border:1px solid var(--qx-border);border-radius:14px;background:var(--qx-surface);padding:7px}.inventory-list>button{display:grid;grid-template-columns:auto 1fr auto auto;gap:9px;align-items:center;width:100%;min-height:56px;border:1px solid transparent;border-radius:9px;background:transparent;color:var(--qx-text);padding:8px;text-align:left;cursor:pointer}.inventory-list>button:hover,.inventory-list>button.on{border-color:var(--qx-border-2);background:var(--qx-surface-2)}.item-copy{display:grid;gap:3px}.item-copy b{font-size:13.5px}.item-copy small{color:var(--qx-text-faint);font-size:11.5px}.inventory-list em{color:var(--qx-text-faint);font-size:11.5px;font-style:normal}.inventory-list i{display:grid;place-items:center;width:22px;height:22px;border-radius:50%;color:var(--qx-text-faint);font-size:13.5px;font-style:normal}.inventory-list i.done{background:var(--qx-green-soft);color:var(--qx-green-text)}.empty{padding:20px;color:var(--qx-text-faint);font-size:13.5px}
  .detail{position:sticky;top:82px;display:grid;gap:14px;border:1px solid var(--qx-border);border-radius:15px;background:var(--qx-surface);padding:18px;box-shadow:var(--qx-shadow-card)}.detail-head{display:grid;grid-template-columns:auto 1fr;gap:5px 9px}.kind{width:max-content;border-radius:999px;background:var(--qx-accent-soft);color:var(--qx-accent-text);padding:5px 8px;font-size:11.5px;font-weight:900;text-transform:uppercase}.detail-head small{align-self:center;color:var(--qx-text-faint);font-size:11.5px}.detail-head h2,.detail-head p{grid-column:1/-1}.detail-head h2{margin:5px 0 0;font-size:22px}.detail-head p{margin:0;color:var(--qx-text-2);font-size:13.5px;line-height:1.55}.facts{display:grid;grid-template-columns:repeat(2,1fr);gap:7px}.facts div{display:grid;gap:4px;border:1px solid var(--qx-border);border-radius:9px;background:var(--qx-surface-2);padding:9px}.facts span,.workshops>span,.decision>span{color:var(--qx-text-faint);font-size:11.5px;font-weight:900}.facts b{font-size:13px;line-height:1.35}.workshops{display:grid;gap:7px}.workshops>div{display:flex;flex-wrap:wrap;gap:5px}.workshops code{border:1px solid var(--qx-border);border-radius:7px;background:var(--qx-surface-2);padding:5px 7px;color:var(--qx-text-2);font-size:11.5px}.decision{display:grid;gap:7px}.decision>div{display:flex;flex-wrap:wrap;gap:5px}.decision button{min-height:36px;border:1px solid var(--qx-border);border-radius:8px;background:var(--qx-surface-2);color:var(--qx-text-2);padding:7px 9px;font-size:11.5px;font-weight:900;cursor:pointer}.decision button.on{border-color:var(--qx-accent);background:var(--qx-accent-soft);color:var(--qx-accent-text)}.decision button.migrate.on{border-color:var(--qx-green);background:var(--qx-green-soft);color:var(--qx-green-text)}.decision button.reject.on{border-color:var(--qx-danger);background:var(--qx-danger-soft);color:var(--qx-danger-text)}.notes textarea{min-height:72px;resize:vertical;font-size:13px;line-height:1.45}.reviewed{display:flex;align-items:flex-start;gap:10px;border:1px solid var(--qx-border);border-radius:10px;background:var(--qx-surface-2);padding:10px;cursor:pointer}.reviewed input{width:18px;height:18px;accent-color:var(--qx-green)}.reviewed span{display:grid;gap:3px}.reviewed b{font-size:13px}.reviewed small{color:var(--qx-text-faint);font-size:11.5px}
  .manifest-status{display:flex;justify-content:space-between;gap:12px;border:1px solid var(--qx-danger);border-radius:12px;background:var(--qx-danger-soft);color:var(--qx-danger-text);padding:13px}.manifest-status.ready{border-color:var(--qx-green);background:var(--qx-green-soft);color:var(--qx-green-text)}.manifest-status b{font-size:13.5px}.manifest-status span{font-size:12px}.manifest-actions{display:flex;align-items:center;gap:12px;margin:12px 0}.manifest-actions button{min-height:40px;border:1px solid var(--qx-accent);border-radius:9px;background:var(--qx-accent-soft);color:var(--qx-accent-text);padding:8px 12px;font-size:12px;font-weight:900;cursor:pointer}.manifest-actions span{color:var(--qx-text-faint);font-size:12px}.manifest-view pre{max-height:620px;overflow:auto;white-space:pre-wrap;border:1px solid var(--qx-border);border-radius:14px;background:var(--qx-surface);padding:17px;color:var(--qx-text-2);font:13px/1.55 ui-monospace,SFMono-Regular,Consolas,monospace}
