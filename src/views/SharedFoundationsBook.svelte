...
<style>
  ...
  .time b { color: #4e6548; font: 900 13px var(--qx-font); }
  ...
  .chapter-head > span { padding: 8px 10px; border-radius: 7px; background: #eef1e9; color: #4e6548; font: 900 7px var(--qx-font); letter-spacing: .08em; white-space: nowrap; }
  .objective { margin-top: 24px; padding: 17px 19px; border-left: 4px solid #5f7355; background: #f2f4ee; }
  .objective b { color: #4e6548; font: 900 8px var(--qx-font); letter-spacing: .1em; }
  ...
  .primary, .done-message { width: 100%; min-height: 44px; margin-top: 12px; display: grid; place-items: center; border: 0; border-radius: 9px; background: #5f7355; color: #fff; font: 900 9px var(--qx-font); }
  ...
  .complete-banner span { color: #4e6548; font: 900 8px var(--qx-font); letter-spacing: .1em; }
