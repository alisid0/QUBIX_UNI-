...
| DSA-ARR-002: Making room in an array | **APPROVED** by founder, 2026-08-28. Scope is the single read-and-do authoring sample only | Placement, roster entry and release remain undecided; approved source files are digest locked |
