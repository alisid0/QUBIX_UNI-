...
| Animated figure: base-rate alarm (ch08.02) | **APPROVED** by founder, 2026-08-28. Scope is the figure only. Amended 2026-08-29 on founder instruction: dead canvas trimmed and free-canvas labels raised for phone legibility; no wording, data or motion changed | Digest locked; the containing session stays `AI_DRAFT` |
...
| Animated figure: join fan-out (ch05.03) | **APPROVED** by founder, 2026-08-28. Scope is the figure only. Amended 2026-08-29 on founder instruction: dead canvas trimmed and free-canvas labels raised for phone legibility; no wording, data or motion changed | Digest locked in `curriculum/APPROVED-FIGURES.json`; the containing session stays `AI_DRAFT` |
| Animated figure: sampling spread (ch08.03) | **APPROVED** by founder, 2026-08-28. Scope is the figure only. Amended 2026-08-29 on founder instruction: dead canvas trimmed and free-canvas labels raised for phone legibility; no wording, data or motion changed | Digest locked; the containing session stays `AI_DRAFT` |
| Animated figure: grain collapse (ch05.02) | **APPROVED** by founder, 2026-08-28. Scope is the figure only. Amended 2026-08-29 on founder instruction: dead canvas trimmed and free-canvas labels raised for phone legibility; no wording, data or motion changed | Digest locked; the containing session stays `AI_DRAFT` |
| DSA-SEQ-001: Sequences and indexed access | **APPROVED** by founder, 2026-08-28. Explanatory direct-access-vs-search contrast figure added 2026-08-29 on founder approval; digest re-locked. Scope is the single read-and-do authoring sample only | Placement, roster entry and release remain undecided; approved source files are digest locked |
| DSA-ARR-002: Making room in an array | **APPROVED** by founder, 2026-08-28. Figure amended 2026-08-29 on founder instruction for phone legibility; digest re-locked. Explanatory read-vs-insert contrast figure added 2026-08-29 on founder approval; digest re-locked. Scope is the single read-and-do authoring sample only. Founder instructed merge and live authoring URL on 2026-08-28 | Roster entry and RELEASED remain undecided; approved source files are digest locked; live at `/?mode=dsa-array-insertion-preview` |
...
| DSA-ARR-003: When the array runs out of room | **APPROVED** by founder, 2026-08-29. Scope is the single read-and-do authoring sample only. Founder instructed the live authoring URL on 2026-08-29 | Roster entry and RELEASED remain undecided; approved source files are digest locked; live at `/?mode=dsa-array-growth-preview` |
