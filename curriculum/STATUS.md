...
| DSA-ARR-002: Making room in an array | **APPROVED** by founder, 2026-08-28. Scope is the single read-and-do authoring sample only. Founder instructed merge and live authoring URL on 2026-08-28 | Roster entry and RELEASED remain undecided; approved source files are digest locked; live at `/?mode=dsa-array-insertion-preview` |
...
| DSA-ARR-003: When the array runs out of room | `AI_DRAFT`, 2026-08-29. Written from the promise made by the approved DSA-ARR-002 precision note. Not reviewed by the founder and absent from `APPROVED-DSA.json` | Founder reading and amendments. Workshop-gated at `/?mode=dsa-array-growth-preview`; the production build drops it entirely, so it cannot stand beside approved material |
