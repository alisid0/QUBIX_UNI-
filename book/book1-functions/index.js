...
import ch10 from './ch10-delta.js';
import ch11 from './ch11-average-rate.js';
import ch12 from './ch12-limits.js';
import ch13 from './ch13-derivatives.js';
import ch14 from './ch14-integrals.js';

export const meta = {
  series: 'QUBIX UNIVERSITY · FOUNDATIONS SERIES',
  title: 'Calculus From The Ground Up',
  subtitle: 'Book 1: Functions',
  blurb: 'Inputs, outputs, graphs, composition, inverse functions, and the arithmetic of change.',
  status: 'REFERENCE E-BOOK · DRAFT 3',
  note: 'Authored in-repo and generated. Every figure is computed from the formula beside it, every answer is drawn, and the back of the book counts what is still missing.'
};

export const chapters = [
  ch01, ch02, ch03, ch04, ch05, ch06, ch07,   // Part I: what a function is
  ch08, ch09,                                  // Part I: combining and reversing
  ch10, ch11,                                  // Part I: change, and measuring it
  ch12, ch13, ch14                             // Part II: the next three books
];
